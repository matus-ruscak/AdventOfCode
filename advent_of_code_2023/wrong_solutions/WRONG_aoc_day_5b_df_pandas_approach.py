...
def extract_maps(input_text):
    ...
    seeds_df = seeds_df.withColumn("water",
                                   when(col("water").isNull(), col("soil")).otherwise(col("water")))
    ...
    print('MIN LOCATION: ', seeds_df.select(min('location')).collect())
...
if __name__ == '__main__':
    ...
    parsed_file = parse_text_file_by_line("../input/aoc_day_5_actual_input.txt")
    aoc_day_5a(parsed_file)
